...
//     <nav class="h-screen w-[80vw] top-0 -right-[80vw] px-5 py-10 transition-right duration-800 ease-in-out peer-checked:right-0 bg-amber-200 fixed rounded-l-3xl">
...
//       <section class="flex flex-col items-center px-4 w-full">
...
//       </section>
//       <section class="w-full h-80 flex items-center justify-center bg-amber-200">
//        <div class="swiper flex select-none bg-slate-400 gap-3 items-center rounded-2xl h-40">
...
//           <spam class="weather_forecast--day">tomorrow</spam>
//           <spam class="weather_forecast--temp"></spam>
//           <spam class="weather_forecast--type"></spam>  
//         </div>
//          <div class="weather_forecast w-50 h-30 shrink-0 bg-amber-300 flex flex-col items-center">
//           <spam class="weather_forecast--day">1</spam>
//           <spam class="weather_forecast--temp"></spam>
//           <spam class="weather_forecast--type"></spam>  
//         </div>
//          <div class="weather_forecast w-50 h-30 shrink-0 bg-amber-300 flex flex-col items-center">
//           <spam class="weather_forecast--day">2</spam>
//           <spam class="weather_forecast--temp"></spam>
//           <spam class="weather_forecast--type"></spam>  
//         </div>
//          <div class="weather_forecast w-50 h-30 shrink-0 bg-amber-300 flex flex-col items-center">
//           <spam class="weather_forecast--day">3</spam>
//           <spam class="weather_forecast--temp"></spam>
//           <spam class="weather_forecast--type"></spam>  
//         </div>
//        </div>
